                ...
                <a class="nav-link {{ request()->is('product') ? 'active' : '' }}" href="{{ route('product') }}">
                    <div
                        ...
                        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 482 482"
                            width="12px" height="12px"
                            style="enable-background:new 0 0 482 482; {{ request()->is('product') ? 'color: white' : '' }} "
                            xml:space="preserve">
                            <g>
                                <g>
                ...
                <a class="nav-link" href="{{ route('profile') }}">
                    <div
                        ...
                        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 482 482"
                            width="12px" height="12px"
                            style="enable-background:new 0 0 482 482; {{ request()->is('store') ? 'color: white' : '' }} "
                            xml:space="preserve">
                            <g>
                                ...
                                <path
                                    d="M352,288.032c-29.21,38.617-43.85,32-96,32s-66.79,6.617-96-32c-32.665,11.334-96,27.824-96,64V480
